...
public class CheckTripleDistributionMapper extends
	...
	protected void map(TripleSource key, Triple value, Context context)
		...
		int partition = Math.abs((int)HashFunctions.JSHash("1225130573719142656 728 1153147729124261888")) % partitions;
		oKey.set(partition);
		context.write(oKey, oValue);

		//oKey.set(Math.abs((int)HashFunctions.JSHashInt(value.toString())) % partitions);
		//context.write(oKey, oValue);

...
public class Generator {
	 ...
	 * @param startIndex
	 *            the index of the first university
	 * @param seed
	 *            random seed
	 */
	...
	private void _generateAFaculty_a(int type, int index) {
		...
		for (int i = 0; i < courseNum; i++) {
			...
			writer_.addProperty(CS_P_TEACHEROF,
					getId(CS_C_COURSE, courseIndex), true);
		}
		// gradutate courses
		...
		for (int i = 0; i < courseNum; i++) {
			...
			writer_.addProperty(CS_P_TEACHEROF,
					getId(CS_C_GRADCOURSE, courseIndex), true);
		}
		// person properties
	...
	private void _generateAProf_a(int type, int index) {
		...
		writer_.addProperty(CS_P_RESEARCHINTEREST,
				getRelativeName(CS_C_RESEARCH, random_.nextInt(RESEARCH_NUM)),
				false);
	}
	 ...
	 *            Maximum number of publications.
	 */
	private void _assignGraduateStudentPublications(long author, int min,
			int max) {
		int num;
		PublicationInfo publication;
	...
	private void _generateAnUndergraduateStudent(int index) {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			writer_.addProperty(CS_P_TAKECOURSE,
					getId(CS_C_COURSE, info.globalIndex), true);
		}
	...
	private void _generateATa(TaInfo ta) {
		writer_.startAboutSection(CS_C_TA,
				getId(CS_C_GRADSTUD, ta.indexInGradStud));
		writer_.addProperty(CS_P_TAOF, getId(CS_C_COURSE, ta.indexInCourse),
				true);
	...
	private void _generateAnRa(RaInfo ra) {
		writer_.startAboutSection(CS_C_RA,
				getId(CS_C_GRADSTUD, ra.indexInGradStud));
	...
	private void _generateACourse(int index) {
		...
		writer_.addProperty(CS_P_NAME, getRelativeName(CS_C_COURSE, index),
				false);
	...
	private void _generateAGraduateCourse(int index) {
		...
		writer_.addProperty(CS_P_NAME, getRelativeName(CS_C_GRADCOURSE, index),
				false);
	...
	private static final long[][] axiomaticTriples = { { 810, 4, 812 },
			{ 13, 4, 5 }, { 14, 4, 4 }, { 0, 4, 0 }, { 3, 4, 3 }, { 2, 4, 2 },
			{ 4, 4, 4 }, { 5, 4, 5 }, { 0, 2, 23 }, { 3, 2, 23 }, { 2, 2, 23 },
			{ 4, 2, 1 }, { 5, 2, 23 }, { 558, 2, 814 }, { 516, 2, 20 },
			{ 520, 2, 20 }, { 816, 5, 818 }, { 820, 5, 818 }, { 822, 5, 818 },
			{ 21, 5, 1 }, { 824, 5, 20 }, { 22, 5, 23 }, { 3, 3, 1 },
			{ 2, 3, 1 }, { 4, 3, 1 }, { 5, 3, 23 }, { 826, 3, 828 },
			{ 830, 3, 828 }, { 832, 3, 828 }, { 550, 3, 814 }, { 558, 3, 814 },
			{ 0, 834, 5 }, { 0, 0, 24 }, { 24, 0, 24 }, { 1, 0, 24 },
			{ 4, 0, 24 }, { 11, 0, 24 }, { 5, 0, 24 }, { 9, 0, 24 },
			{ 10, 0, 24 }, { 14, 0, 24 }, { 13, 0, 24 }, { 0, 0, 1 },
			{ 826, 0, 1 }, { 830, 0, 1 }, { 832, 0, 1 }, { 550, 0, 1 },
			{ 558, 0, 1 }, { 836, 0, 1 }, { 562, 0, 814 }, { 824, 0, 22 },
			{ 13, 0, 10 }, { 13, 0, 9 }, { 14, 0, 10 }, { 14, 0, 9 },
			{ 11, 0, 9 }, { 12, 0, 9 }, { 5, 0, 10 }, { 4, 0, 10 },
			{ 838, 0, 9 }, { 840, 0, 22 }, { 842, 0, 22 } };

	// The schema dictionary encoded
	private static final long[][] schema = { { 512, 0, 514 }, { 512, 0, 514 },
			{ 512, 516, 519 }, { 512, 520, 523 }, { 512, 524, 527 },
			{ 528, 0, 6 }, { 528, 520, 531 }, { 528, 5, 532 }, { 534, 0, 6 },
			{ 534, 520, 537 }, { 534, 5, 143 }, { 134, 0, 6 },
			{ 134, 520, 539 }, { 134, 5, 131 }, { 133, 0, 6 },
			{ 133, 520, 541 }, { 133, 5, 131 }, { 542, 0, 6 },
			{ 542, 520, 545 }, { 542, 5, 143 }, { 144, 0, 6 },
			{ 144, 520, 547 }, { 548, 550, 552 }, { 552, 0, 6 },
			{ 554, 550, 556 }, { 548, 558, 554 }, { 556, 0, 560 },
			{ 556, 16, 73 }, { 129, 0, 6 }, { 556, 17, 129 },
			{ 554, 558, 562 }, { 144, 564, 548 }, { 144, 5, 131 },
			{ 566, 0, 6 }, { 566, 520, 569 }, { 566, 5, 528 }, { 570, 0, 6 },
			{ 570, 520, 573 }, { 570, 5, 574 }, { 576, 0, 6 },
			{ 576, 520, 579 }, { 576, 5, 534 }, { 141, 0, 6 },
			{ 141, 520, 581 }, { 141, 5, 582 }, { 584, 0, 6 },
			{ 584, 520, 587 }, { 588, 550, 552 }, { 552, 0, 6 },
			{ 590, 550, 592 }, { 588, 558, 590 }, { 592, 0, 560 },
			{ 592, 16, 73 }, { 570, 0, 6 }, { 592, 17, 570 },
			{ 590, 558, 562 }, { 584, 564, 588 }, { 584, 5, 131 },
			{ 129, 0, 6 }, { 129, 520, 595 }, { 129, 5, 574 }, { 596, 0, 6 },
			{ 596, 520, 599 }, { 600, 550, 552 }, { 552, 0, 6 },
			{ 602, 550, 604 }, { 600, 558, 602 }, { 604, 0, 560 },
			{ 604, 16, 73 }, { 606, 0, 6 }, { 604, 17, 606 },
			{ 602, 558, 562 }, { 596, 564, 600 }, { 532, 0, 6 },
			{ 532, 520, 609 }, { 610, 550, 552 }, { 552, 0, 6 },
			{ 612, 550, 614 }, { 610, 558, 612 }, { 614, 0, 560 },
			{ 614, 16, 79 }, { 574, 0, 6 }, { 614, 17, 574 },
			{ 612, 558, 562 }, { 532, 564, 610 }, { 130, 0, 6 },
			{ 130, 520, 617 }, { 130, 5, 532 }, { 132, 0, 6 },
			{ 132, 520, 619 }, { 132, 5, 131 }, { 142, 0, 6 },
			{ 142, 520, 621 }, { 142, 5, 141 }, { 138, 0, 6 },
			{ 138, 520, 623 }, { 138, 5, 552 }, { 624, 0, 560 },
			{ 624, 16, 65 }, { 142, 0, 6 }, { 624, 17, 142 }, { 138, 5, 624 },
			{ 626, 0, 6 }, { 626, 520, 629 }, { 626, 5, 574 }, { 630, 0, 6 },
			{ 630, 520, 633 }, { 630, 5, 534 }, { 135, 0, 6 },
			{ 135, 520, 635 }, { 135, 5, 130 }, { 636, 0, 6 },
			{ 636, 520, 639 }, { 636, 5, 143 }, { 574, 0, 6 },
			{ 574, 520, 641 }, { 552, 0, 6 }, { 552, 520, 643 }, { 644, 0, 6 },
			{ 644, 520, 647 }, { 644, 5, 130 }, { 131, 0, 6 },
			{ 131, 520, 649 }, { 131, 5, 130 }, { 606, 0, 6 },
			{ 606, 520, 651 }, { 606, 5, 574 }, { 143, 0, 6 },
			{ 143, 520, 653 }, { 145, 0, 6 }, { 145, 520, 655 },
			{ 145, 5, 582 }, { 140, 0, 6 }, { 140, 520, 657 }, { 140, 5, 136 },
			{ 658, 0, 560 }, { 658, 16, 79 }, { 146, 0, 6 }, { 658, 17, 146 },
			{ 140, 5, 658 }, { 146, 0, 6 }, { 146, 520, 661 }, { 146, 5, 574 },
			{ 662, 0, 6 }, { 662, 520, 665 }, { 666, 0, 6 }, { 666, 520, 669 },
			{ 666, 5, 143 }, { 670, 0, 6 }, { 670, 520, 673 }, { 670, 5, 143 },
			{ 136, 0, 6 }, { 136, 520, 675 }, { 676, 550, 552 }, { 552, 0, 6 },
			{ 678, 550, 680 }, { 676, 558, 678 }, { 680, 0, 560 },
			{ 680, 16, 65 }, { 141, 0, 6 }, { 680, 17, 141 },
			{ 678, 558, 562 }, { 136, 564, 676 }, { 682, 0, 6 },
			{ 682, 520, 685 }, { 682, 5, 528 }, { 139, 0, 6 },
			{ 139, 520, 687 }, { 688, 550, 552 }, { 552, 0, 6 },
			{ 690, 550, 692 }, { 688, 558, 690 }, { 692, 0, 560 },
			{ 692, 16, 74 }, { 141, 0, 6 }, { 692, 17, 141 },
			{ 690, 558, 562 }, { 139, 564, 688 }, { 694, 0, 6 },
			{ 694, 520, 697 }, { 694, 5, 534 }, { 137, 0, 6 },
			{ 137, 520, 699 }, { 137, 5, 136 }, { 128, 0, 6 },
			{ 128, 520, 701 }, { 128, 5, 574 }, { 702, 0, 6 },
			{ 702, 520, 705 }, { 702, 5, 143 }, { 706, 0, 6 },
			{ 706, 520, 709 }, { 706, 5, 131 }, { 582, 0, 6 },
			{ 582, 520, 711 }, { 70, 0, 712 }, { 70, 520, 715 },
			{ 70, 3, 552 }, { 70, 2, 131 }, { 716, 0, 712 }, { 716, 520, 719 },
			{ 716, 3, 574 }, { 716, 2, 574 }, { 720, 0, 712 },
			{ 720, 520, 719 }, { 720, 3, 574 }, { 720, 2, 552 },
			{ 722, 0, 724 }, { 722, 520, 727 }, { 722, 3, 552 },
			{ 728, 0, 712 }, { 728, 520, 731 }, { 728, 3, 552 },
			{ 728, 2, 128 }, { 728, 12, 732 }, { 69, 0, 712 },
			{ 69, 520, 735 }, { 69, 3, 552 }, { 69, 2, 128 }, { 69, 4, 728 },
			{ 76, 0, 724 }, { 76, 520, 737 }, { 76, 3, 552 }, { 732, 0, 712 },
			{ 732, 520, 739 }, { 732, 3, 128 }, { 732, 2, 552 },
			{ 732, 12, 728 }, { 73, 0, 712 }, { 73, 520, 741 }, { 73, 4, 79 },
			{ 742, 0, 712 }, { 742, 520, 745 }, { 742, 3, 662 },
			{ 742, 2, 141 }, { 68, 0, 712 }, { 68, 520, 747 }, { 68, 3, 552 },
			{ 68, 2, 128 }, { 68, 4, 728 }, { 748, 0, 712 }, { 748, 520, 751 },
			{ 748, 3, 574 }, { 748, 2, 552 }, { 71, 0, 712 }, { 71, 520, 753 },
			{ 71, 12, 748 }, { 64, 0, 724 }, { 64, 520, 755 }, { 756, 0, 724 },
			{ 756, 520, 759 }, { 760, 0, 712 }, { 760, 520, 763 },
			{ 760, 3, 574 }, { 760, 2, 143 }, { 72, 0, 712 }, { 72, 520, 765 },
			{ 72, 3, 143 }, { 72, 2, 552 }, { 766, 0, 712 }, { 766, 520, 769 },
			{ 766, 3, 143 }, { 770, 0, 712 }, { 770, 520, 773 },
			{ 770, 3, 143 }, { 770, 2, 145 }, { 75, 0, 724 }, { 75, 520, 775 },
			{ 776, 0, 712 }, { 776, 520, 779 }, { 776, 3, 146 },
			{ 776, 2, 145 }, { 780, 0, 712 }, { 780, 520, 783 },
			{ 780, 3, 666 }, { 780, 2, 143 }, { 784, 0, 712 },
			{ 784, 520, 787 }, { 784, 3, 666 }, { 78, 0, 10 },
			{ 78, 520, 789 }, { 78, 3, 574 }, { 78, 2, 574 }, { 65, 0, 712 },
			{ 65, 520, 791 }, { 66, 0, 712 }, { 66, 520, 793 }, { 66, 3, 130 },
			{ 66, 2, 141 }, { 74, 0, 712 }, { 74, 520, 795 }, { 74, 3, 139 },
			{ 74, 2, 141 }, { 77, 0, 724 }, { 77, 520, 797 }, { 77, 3, 552 },
			{ 798, 0, 712 }, { 798, 520, 801 }, { 798, 3, 131 },
			{ 802, 0, 724 }, { 802, 520, 805 }, { 802, 3, 552 },
			{ 67, 0, 712 }, { 67, 520, 807 }, { 67, 3, 552 }, { 67, 2, 128 },
			{ 67, 4, 728 }, { 79, 0, 712 }, { 79, 520, 809 }, { 79, 4, 71 } };

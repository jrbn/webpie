...
public class ExportTriplesReconstructReducer extends Reducer<LongWritable, BytesWritable, NullWritable, Text> {
	...
	throws IOException, InterruptedException {
		...
		while (itr.hasNext()) {
			...
			case 1:
				...
				break;
			case 2:
				predicate = new String(value.getBytes(),1,value.getLength() - 1);
				break;
			case 3:

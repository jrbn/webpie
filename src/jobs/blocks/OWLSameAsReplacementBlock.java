...
public class OWLSameAsReplacementBlock extends ExecutionBlock {
	...
	public void performJobs(int executionStep) throws IOException,
		...
		Counter cDerivedSynonyms = job.getCounters().findCounter("reasoner",
				"substitutions");
		long replacements = cDerivedSynonyms.getValue();
		...
		setFilteredDerivation(replacements);
		setNotFilteredDerivation(replacements);
		setHasDerived(replacements > 0);
